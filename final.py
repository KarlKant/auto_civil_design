...
print('air circulation ratio',changeRate)
print('convection heat transfer coefficient of the inner wall of the carriage',h_air)
print('pipe inner wall temperature',T_tube)
print('radiation degree of inner wall of pipe',YiPu_tube)
print('initial body temperature',temp_wall)
print('body surface radiation',YiPu_pod)
print('thermal diffusion coefficient',alpha_pod)
print('thermal conductivity',lanbu_pod)
print('iteration time step',time_step)
print('iteration space step size',long_step)
print('total running time',time_long)
#print(air.names['totalV'],round(air.totalV,2),air.dimension['totalV'])
print('===Result===')
plt.figure(1)
plt.plot(T_pod['temp0'])
